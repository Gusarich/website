...
export const PostMeta = {
    ...
    addCopyLinkButton() {
        ...
        if (!postMetaElement || postMetaElement.querySelector('.copy-link-btn')) {
            return;
        }
    ...
    addCopyMarkdownButton(slug) {
        ...
        if (
            !postMetaElement ||
            postMetaElement.querySelector('.copy-markdown-btn')
        ) {
            return;
        }
    ...
    addCitationButton(slug) {
        const postMetaElement = document.querySelector('.post-meta');
        if (!postMetaElement || postMetaElement.querySelector('.citation-btn')) {
            return;
        }
    ...
    showCitationModal(slug) {
        ...
        const bibtex = this.generateBibTeXCitation(
            title,
            year,
            month,
            day,
